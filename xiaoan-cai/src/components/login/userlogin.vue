    ...
    export default {
        ...
        data() {
            return {
                ...
                password: "",
                regnumber: "",
                imgSrc: "/static/img/personal/timg@2x.png",
                ImageCode: "",
                showErr: false,
                showregErr: true,
                regError: false,
        ...
        created() {
            ...
            this.ImageCode = this.$api.host + 'getImageCode/?' + new Date().getTime();
        ...
        methods: {
            ...
            getWxInfo() {
                this.$http({
                    ...
                    console.log(res)
                    this.Register = false; //未授权登录
                    if (res.data.returnObject.weixinAvatar !== '') {
            ...
            apiImgCodeCheck() {
                this.$http({
                    method: "GET",
                    url: this.$api.host + 'imgCodeCheck',
                    params: {
                        code: this.regnumber,
                    }
                }).then((res) => {
