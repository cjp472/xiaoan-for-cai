  ...
  <div id="personal-info" class="personal-info">
    <form action="" onsubmit=" return false">
      ...
      <div class="regsitor" :class="{borderColor: passBox.regErr.borColor}">
        ...
        <p class="regnum" @click="sendSmsCode()" ref="regNum">
          {{ getNumber }}
...
<script>
  export default {
    ...
    data() {
      return {
        chengseduigou: "/static/img/personal/chengseduigou.png",
        username: "",
        email: '',
        password: "",
        apassword: "",
    ...
    methods: {
      ...
      next() {
        ...
        if (this.passvalid == true && this.apassvalid == true && this.checked == false && this.regvalid == true) {
          this.$toast({message: "请阅读并勾选《小安用户协议》！", position: 'middle', duration: 1500});
        }
        ...
        if (this.passvalid == true && this.apassvalid == true && this.checked == true && this.regvalid == true) {
          ...
          // this.$toast({
          //     message: ("passvalid" + this.passvalid + "appa" + this.apassvalid + "checked" + this.checked + "regvalid" + this.regvalid),
          //     position: 'middle',
          //     duration: 1500
          // });
      ...
      mobileRegister() {
        this.$http({
          method: "POST",
          url: this.$api.host + 'mobileRegister',
          params: {
            mobile: this.phoneNumber,
          ...
          if (res.data.returnCode == "-1") {
            ...
            this.$router.push({path: '/manage/reviseInfo', query: {mobile: this.phoneNumber, id: 1}});
          }
        }).catch((err) => {
          console.log(err)
