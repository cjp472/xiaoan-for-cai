    ...
    export default {
        ...
        created() {
            ...
            if (wxAuth) {
                ...
                // 没有
                this.$weixin.wxAuthRedirect('INVOICE');
            }
            this.getInvoiceList();
        },
        mounted() {
        ...
        methods: {
            ...
            getInvoiceList() {
                this.$http({
                    method: 'GET',
                    url: global.host + 'invoice/getInvoiceList',
                    params: {
                        weixinId: this.tempUserIdS,
                        page: this.pageIndex,
                    }
                }).then((res) => {
            ...
            BtnOne() {
                this.$router.push({
                    path: '/application',
                    query: {weixinId: this.tempUserIdS, MathTime: global.timestamp}
                });
            },
            BtnTwo() {
