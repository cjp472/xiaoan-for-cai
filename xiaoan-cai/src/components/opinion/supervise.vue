<template>
    <transition name="bounce">
        <div id="supervise" class="supervise">
            ...
            <div class="container">
                <div class="allbtn">
                    <p>
                        <span>微信提醒</span>
                        <span>
                            <mt-switch v-model="switchWx"></mt-switch>
                        </span>
                    </p>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            apiGetAllProject() {
                ...
                this.$http({
                    ...
                    if (res.data.returnCode == 1) {
                        ...
                        this.$toast({message: '出现未知错误，请联系管理员', position: "middle", duration: 2000});
            ...
            apiAddProject() {
                ...
                this.$http({
                    method: 'GET',
                    url: this.$api.host + "sentiment/addProject",
                    params: {
                    ...
                    if (res.data.returnCode == 1) {
                        ...
                        this.loading = false;
                        this.$toast({message: '项目名和关键词都不能为空！', position: "middle", duration: 2000});
                    }
                }).catch((err) => {
                    console.error(err);
                })
            ...
            apiUpdateProject() {
                ...
                this.$http({
                    method: 'GET',
                    url: this.$api.host + "sentiment/updateProject",
                    params: {
