    ...
    <div id="usertable">
        <div class="headerLine">
            <div class="companyInfo">
                ...
                <div class="companyUnit">
                    <div class="companyCode">{{ code }}</div>
    ...
    export default {
        ...
        methods: {
            ...
            listHeight() {
                ...
                var ghg = (hei - document.querySelector('.headerLine').clientHeight - 7.5) + "px";
            ...
            goCust() {
                /*let array = [-3];
                this.$storage.localStorageSystem("customerTables", array, false);*/
...
<style scoped>
    ...
    #usertable .innerCustomerGSelect {
        width: auto;
        float: right;
    }
    #usertable .innerCustomerGSelect #selects {
    ...
    #usertable .innerCustomerGSelect select option {
        color: #323232;
    }
    /* */
