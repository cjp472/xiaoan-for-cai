        ...
        <div class="column">
            ...
            <div class="column_Search">
                <div slot="icon" @click="searchReport" class="searchIcon">
                    <i class="icon iconfont icon-sousuo1" style="color:#fff;"></i>
                </div>
            </div>
        </div>
        <div class="container">
                    ...
                    <div class="myReport" v-show="this.secondary[2].isLight">
                        ...
                        <div class="nav-tab">
                            ...
                            <p v-show="myInfLoading" class="infinite-loading">
                                <mt-spinner type="snake" v-if="myAllLoaded"></mt-spinner>
                                <span v-if="myAllLoaded" style="vertical-align: middle">加载中...</span>
                    ...
                    <div class="focusReport" v-show="this.secondary[1].isLight">
                        ...
                        <div class="nav-tab">
                            ...
                            <p v-show="focusInfLoading" class="infinite-loading">
                                <mt-spinner type="snake" v-if="focusAllLoaded"></mt-spinner>
                                <span v-if="focusAllLoaded" style="vertical-align: middle">加载中...</span>
                                <xiaoan-drop v-else></xiaoan-drop>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="newReport" :class="{noInfo:isNewShow}" v-show="this.secondary[0].isLight">
                        ...
                        <div class="nav-tab">
                            ...
                            <p v-show="newInfLoading" class="infinite-loading">
                                <mt-spinner type="snake" v-if="newAllLoaded"></mt-spinner>
                                <span v-if="newAllLoaded" style="vertical-align: middle">加载中...</span>
                                <xiaoan-drop text="仅显示最近一周发版的研报" v-else></xiaoan-drop>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="secondContent" :class="{noInfo:isCompanyShow}">
                    ...
                    <div class="nav-tab">
                        ...
                        <p v-show="comInfLoading" class="infinite-loading">
                            <mt-spinner type="snake" v-if="comAllLoaded"></mt-spinner>
                            <span v-if="comAllLoaded" style="vertical-align: middle">加载中...</span>
                            <xiaoan-drop v-else></xiaoan-drop>
                        </p>
                    </div>
                </div>
                ...
                <div class="secondContent" :class="{noInfo:isInsdustryShow}">
                    ...
                    <div class="nav-tab">
                        ...
                        <p v-show="insInfLoading" class="infinite-loading">
                            <mt-spinner type="snake" v-if="insAllLoaded"></mt-spinner>
                            <span v-if="insAllLoaded" style="vertical-align: middle">加载中...</span>
                            <xiaoan-drop v-else></xiaoan-drop>
                        </p>
                    </div>
                </div>
                ...
                <div class="secondContent" :class="{noInfo:isMultipleShow}">
                    ...
                    <div class="nav-tab">
                        ...
                        <p v-show="mulInfLoading" class="infinite-loading">
                            <mt-spinner type="snake" v-if="mulAllLoaded"></mt-spinner>
                            <span v-if="mulAllLoaded" style="vertical-align: middle">加载中...</span>
                            <xiaoan-drop v-else></xiaoan-drop>
                        </p>
                    </div>
                </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                hintImg: '../../static/img/report/noReportInfo.png',
                ...
                hintBtnText: '前往关注',
                hintNoFocusImg: '../../static/img/personal/focus/toFocus.png',
                reportArr: [],//我的研报信息
        ...
        methods: {
            ...
            getIndustry_multiple(index) {
                this.$http({
                    methods: 'GET',
                    url: host + 'report/getIntegratedReportByType',
                    params: {
            ...
            getAllMultiple() {
                this.$http({
                    methods: 'GET',
                    url: host + 'report/getAllIntegratedReport',
                    params: {
                        pageNum: this.allMultiplePage,
                        pageSize: this.pagesize
                    }
...
//            if(this.multipleSecond == '' || this.multipleSecond == 0){
            ...
            getMultipleSort() {
                this.$http({
                    methods: 'GET',
                    url: host + 'report/getIntegratedTypeList'
                }).then((res) => {
                    console.log(res)
                    if (res.data.returnCode == 1) {
                        var arr = res.data.returnObject;
            ...
            getIndustry_industry(index) {
                this.$http({
                    methods: 'GET',
                    url: host + 'report/getAllIndutryReportByIndustry',
                    params: {
            ...
            getAllIndustry() {
                this.$http({
                    methods: 'GET',
                    url: host + 'report/getAllIndustryReport',
                    params: {
                        pageNum: this.allIndustryPage,
                        pageSize: this.pagesize
                    }
            ...
            getIndustrySort() {
                this.$http({
                    methods: 'GET',
                    url: host + 'report/getIndustryTypeList'
                }).then((res) => {
                    console.log(res)
                    if (res.data.returnCode == 1) {
                        var arr = res.data.returnObject;
            ...
            getIndustry(index) {
                ...
                this.$http({
                    methods: 'GET',
                    url: host + 'report/getAllCompanyReportByIndustry',
                    params: {
            ...
            getCompanySort() {
                this.$http({
                    methods: 'GET',
                    url: host + 'report/getAllCompanyIndustryList'
                }).then((res) => {
                    console.log(res)
                    if (res.data.returnCode == 1) {
                        var arr = res.data.returnObject;
            ...
            getAllCompany() {
                this.$http({
                    methods: 'GET',
                    url: host + 'report/getAllCompanyReport',
                    params: {
                        pageNum: this.allCompanyPage,
                        pageSize: this.pagesize
                    }
            ...
            getNewReport() {
                this.$http({
                    methods: 'GET',
                    url: host + 'report/getNewResearchReport',
                    params: {
            ...
            getMyFocusReport() {
                this.$http({
                    methods: 'GET',
                    url: host + 'report/getMyAttentionCompany',
                    params: {
                        userId: this.user_Id,
            ...
            getMyReport() {
                ...
                this.$http({
                    methods: 'GET',
                    url: host + 'report/getMyResearchReport',
                    params: {
                        userId: this.user_Id,
                        pageNum: this.myPage,
                        pageSize: this.pagesize
            ...
            containerHeight() {
                ...
                var searchs = document.querySelector(".column").clientHeight;
                var mintTabbar = document.querySelector(".mint-tabbar").clientHeight;
                var heig = (hei - (searchs + mintTabbar)) + "px";
                $('.container').height(heig);//一级内容区域高度自适应

                var secondary = document.querySelector(".secondary").clientHeight;
                var secondContentHeight = (hei - (searchs + secondary + mintTabbar)) + "px";
            ...
            // 跳转我的关注，添加关注
            goMyFocus() {
                this.$router.push({path: "/Addfocus", query: {MathTime: global.timestamp}});
            ...
            reportContent(index, num) {
                ...
                this.$router.push({
                    path: '/detailReport',
                    query: {id: index, MathTime: global.timestamp}
                });
            },
            // 综合查看更多
            loadMorec() {
