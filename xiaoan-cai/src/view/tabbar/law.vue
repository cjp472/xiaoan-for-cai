<template>
  <div class="law" id="law">
    ...
    <xiaoan-warning v-show="warning.show" :message="warning.text" :imgSrc="warning.img"
                    :isShowBtn="warning.isShowBtn" @click="goFocus"></xiaoan-warning>
  </div>
</template>
<script>
  ...
  export default {
    ...
    mounted() {
      this.$nextTick(() => {
        ...
        this.$nextTick(() => {
          console.log('1212313123', process.env.NODE_ENV);
          // console.log(this.$refs.linkDom.offsetTop, this.$refs.linkDom.clientHeight);
          // this.guideStyle.top = this.$refs.linkDom.offsetTop - (this.$refs.guideIDom.clientHeight / 2) + 'px';
          if (process.env.NODE_ENV === 'dev' || process.env.NODE_ENV === 'development') {
            window.localStorage.setItem('token', '5c1c7c5cf985413fa06f79c27387cff0');
            window.localStorage.setItem('weixinId', 'ofZMgwhdOCOC9btPD6WI7OOcJ5AQ');
            window.localStorage.setItem('wx-auth', '{"openId":"ofZMgwhdOCOC9btPD6WI7OOcJ5AQ","nickname":"Evans","sex":1,"country":"CN","province":"Shanghai","city":"Po","headImgUrl":"http://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTLXBvOntwXYsxGugvibFwKcvRf6KYOCzs4h0k4RLpl19YpKRpqveVUSAYhyKvAiad42ibPXT43oBRAJg/132","unionid":"ol83MwZnBK4fHoeq_2iZuxEN628k","privilegeList":null}');
            window.localStorage.setItem('wx-my-home', '{"id":1446,"userName":"Evans","password":null,"realName":"cai","mobile":"15821261066","email":"","position":null,"positionOther":null,"companyName":"长发集团长江投资实业股份有限公司","companyProvince":"请选择","companyCity":"请选择","companyTown":"请选择","companyStreet":"","provinceId":"0","cityId":"001","areaId":"0001","companyTypeOne":"监管机构及个人","companyTypeTwo":"证监会","companyCode":"","weixinId":"ofZMgwhdOCOC9btPD6WI7OOcJ5AQ","weixinUsername":"Evans","weixinUnionId":"ol83MwZnBK4fHoeq_2iZuxEN628k","weixinAvatar":"http://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTLXBvOntwXYsxGugvibFwKcvRf6KYOCzs4h0k4RLpl19YpKRpqveVUSAYhyKvAiad42ibPXT43oBRAJg/132","regDatetime":null,"level":0,"memberId":null,"token":"5c1c7c5cf985413fa06f79c27387cff0","registerFrom":0,"hasLyz":null,"lyzUrl":null,"stockType":null}');
          }
        });
      });
      //
