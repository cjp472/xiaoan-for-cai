    ...
    export default {
        ...
        mounted() {
            this.$nextTick(() => {
                ...
                let headSearch = document.querySelector(".headSearch").clientHeight;
                let mintTabbar = document.querySelector(".mint-tabbar").clientHeight;
                let ghg = (hei - (headSearch + mintTabbar)) + "px";
                $('#wrapper').height(ghg);
                console.log(hei, headSearch, mintTabbar, ghg);
            })
            //
            setTimeout(() => {
                this.$nextTick(() => {
