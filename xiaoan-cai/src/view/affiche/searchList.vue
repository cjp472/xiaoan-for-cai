...
<script>
    ...
    export default {
        ...
        updated() {
            ...
            var SXpup = (hei - 90) + "px";
            var hgt = (hei - (document.querySelector('.searchs').clientHeight) - (document.querySelector('.mint-tabbar').clientHeight) - (document.querySelector('.searchBox').clientHeight)) + 'px';
