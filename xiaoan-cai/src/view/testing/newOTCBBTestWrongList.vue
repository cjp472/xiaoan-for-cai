            ...
            <footer class="newOTCBBTestFooter">
                ...
                <button @click="questionCollect()">
                    <i class="icon-middleCollect">
                        <img src="/static/img/testing/testWrongCollect@3x.png" alt="">
                    </i>
    ...
    export default {
        ...
        methods: {
            ...
            getErrorQuestion(questionPage) {
                this.$http({
                    method: "POST",
                    url: this.$api.host + "sectest/getErrorQuestion",
                    params: {
            ...
            questionCollect() {
                if (this.payMode == 0) {
                    ...
                    if (this.isCollect == false) {
                        ...
                        this.$toast({message: '您已收藏过了', position: 'middle', duration: 1000});
                    }
                }
            },
            addQuestion(questionID) {
                this.$http({
                    method: "POST",
                    url: this.$api.host + "sectest/collectQuestion",
                    params: {
                    ...
                    if (res.data.returnCode == 1) {
                        this.getErrorQuestion(this.page);
                        this.$toast({message: '收藏成功', position: 'middle', duration: 1000});
                    ...
                    this.$toast({message: '收藏失败，请稍后尝试', position: 'middle', duration: 1000});
                })
            },
            lineHeight() {
