                            ...
                            <div class="testingEnd-EChart-radar-show">
                                <div class="testingEnd-EChart-radar-link">
                                    ...
                                    <div class="testingEnd-EChart-radar-topLeft">
                                        ...
                                        &ensp;<span>用时<span class="fontFm">{{useTime.hour+":"}}{{useTime.minute+":"}}{{useTime.second}}</span></span>
                                    </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                leftIcon: true,
                textLeft: '进入小安',
                str: '../../static/img/testing/star-5@3x.png',
                str1: '../../static/img/testing/star-6@3x.png',
                str05: "../../static/img/testing/star05.png",
                headerTouxiang: '',
                username: '',
                user_id: '',
                testPopupJies: '',
                fenxiang: '../../static/img/share/fengxiang.jpg',
                touxiang: '../../static/img/testing/toyxiang9@3x_87.png',
                ...
                contentSets: [
                    {
                        ...
                        errorCount: "",
                        rightCount: "",
                        imgUrl: '/static/img/testing/testMistake@3x.png'
                    }, {
                        id: "",
                        type: "",
                        title: "查看收藏错题",
                        ...
                        globalCount: "",
                        status: "",
                        imgUrl: '/static/img/testing/testCollectMistake@3x.png'
                    }, {
                        id: "",
                        type: "",
                        title: "",
        ...
        methods: {
            ...
            shareSuccess() {
                this.$http({
                    method: "POST",
                    url: this.$api.host + "sectest/shareSuccess",
                    params: {}
                }).then((res) => {
                    this.$toast({message: '分享成功！', position: 'middle', duration: 1500});
                    this.userTestInfo();
                }).catch((err) => {console.error(err);
                    this.$toast({message: '分享失败！', position: 'middle', duration: 1500});
                })
            },
            coll(value) {
                let val = (value * 100) + "%";
            ...
            selectReport(testId) {
                this.$http({
                    method: "POST",
                    url: this.$api.host + "sectest/selectReport",
                    params: {
                        testId: testId,
                    }
                }).then((res) => {
            ...
            userTestInfo() {
                this.$http({
                    method: "POST",
                    url: this.$api.host + "sectest/userTestInfo",
                    params: {}
                }).then((res) => {
                    console.log(res);
                    if (res.data.returnCode === 1) {
                        ...
                        this.$router.push({path: "/testing", query: {MathTime: global.timestamp}});
                    }
                }).catch((err) => {console.error(err);
            ...
            xsbSelectResult() {
                this.$http({
                    method: "POST",
                    url: this.$api.host + "sectest/xsbSelectResult",
                    params: {}
                }).then((res) => {
                    console.log("===============>", res);
                    ...
                    let shareimgUrl = shareImg2; // 分享图标
            ...
            seeCollectError() {
                if (this.payMode == 0) {
                    window.location.href = window.location.href.split("#/")[0] + "?#/newOTCBBTestDescribe?MathTime=" + global.timestamp;
                } else {
                    if (this.contentSets[1].collectCount == 0) {
                        this.$toast({message: '暂无收藏！', position: 'middle', duration: 1000});
                    } else {
                        this.$router.push({path: "/newOTCBBTestCollect", query: {MathTime: global.timestamp}});
                    }
                }
            },
            /*收藏错题*/
            seeError() {
                if (this.payMode == 0) {
                    if (this.contentSets[0].errorCount == 0) {
                        this.$toast({message: '没有错题哦，你真棒👍！', position: 'middle', duration: 1000});
                    } else {
                        this.$router.push({
                            path: "/newOTCBBTestWrongList",
                            query: {testId: this.testId, MathTime: global.timestamp}
                        });
                    }
                } else {
                    this.$router.push({
                ...
                // this.$toast({message: 'seeError', position: 'middle', duration: 1000});
            },
            /**/
            seeReceive() {
                //  window.location.href = this.seeReceiveUrl;
                //this.$toast({message: '等Alex给链接', position: 'middle', duration: 1000});
            },
            /* 回到主页 */
            goLaw() {
            ...
            testEndFenXiang() {
                if (this.payMode == 0) {
                    if (this.examCount == 0 && this.shareuserTestInfo == false) {
                        ...
                        this.$toast({message: '免费用户本月次数已用完', position: 'middle', duration: 1000});
                    } else {
                        this.$router.push({
                            path: "/newOTCBBTestingList",
                            query: {entrance: 1, MathTime: global.timestamp}
                        });
                    }
                }
            },
            ...
            testEndGOList() {
                if (this.hasNoDone == 'y') {
                    this.$router.push({path: "/newOTCBBTestingList", query: {entrance: 1, MathTime: global.timestamp}});
                } else {
                    this.$router.push({path: "/newTestPlate", query: {MathTime: global.timestamp}});
                }
...
<style lang="scss">
    .newOTBCCTestingEnd {
        ...
        background-image: url("/static/img/testing/back2@3x.png");
                                ...
                                .testingEnd-EChart-radar-link {
                                    ...
                                    .testingEnd-EChart-radar-topRight {
                                        ...
                                        .testingEnd-EChart-radar-topRightIcon {
                                            width: 16px;
                                            background: url("/static/img/testing/testEndPlace@3x.png") no-repeat;
                                            background-size: contain;
                                            display: table-cell;
                                        }
                                    }
                                    .testingEnd-EChart-radar-topLeft {
                                        ...
                                        .testingEnd-EChart-radar-topLeftIcon {
                                            width: 16px;
                                            background: url("/static/img/testing/testEndTime@3x.png") no-repeat;
                                            background-size: contain;
                                            display: table-cell;
                                        }
                                        .span {
                    ...
                    .testingEnd-content-detailsTop {
                        ...
                        span {
                            ...
                            .testingEnd-content-detailsTopICon {
                                background: url("/static/img/testing/testTopmiddle@3x.png") no-repeat;
                                background-size: contain;
                                height: 20px;
                                width: 20px;
                                display: table-cell;
        ...
        .testEndFenXiang {
            ...
            div {
                background: url("/static/img/testing/fenxiangOTCBB@3x.png");
                background-repeat: no-repeat;
                background-size: contain;
                width: 276.097px;
                height: 270px;
        ...
        .testPopup {
            ...
            .testPopupBoxL {
                ...
                .testPopupBox {
                    ...
                    position: relative;
                    .testPopupIcon {
                        background: url("/static/img/testing/touxiang@3x.png");
                        background-repeat: no-repeat;
                        background-size: 100% 100%;
                        width: 130px;
                        height: 123.36px;
