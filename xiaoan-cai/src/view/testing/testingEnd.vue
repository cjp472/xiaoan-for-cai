                ...
                <div class="testingEnd-title-right">
                    <div class="testingEnd-title-charm">
                        ...
                        <span class="testingEnd-title-charm-star">
                            ...
                            <img v-lazy="str" alt="" v-else="charms == 30"/>
                        </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="testingEnd-content">
                        ...
                        <div class="testingEnd-content-list">
                            <div v-for="(list,index) in testItem">
                                <router-link :to="'/rulesCount?id='+list.statuteLink">
    ...
    export default {
        ...
        methods: {
            selectResult() {
                this.$http({
                    method: "GET",
                    url: this.$api.host + "sectest/selectResult",
                    params: {
                        /*userId: this.user_id,*/
                    ...
                    console.log('noncestr', noncestr, 'timestamp', timestamp, 'url', url, "分享出去", this.testPopupJies);
                    /*todo
                    * link,url
                    * */
                    console.log("324324234234234========", this.username, this.usernames, this.testPopupJies, this.designation);

                    this.$http({
                        method: 'GET',
                        url: this.$api.host + "shareSign",
                        params: {
                            noncestr: noncestr,
                            timestamp: timestamp,
                    ...
                    var shareimgUrl = shareImg2; // 分享图标
            ...
            linkTest() {
                if (this.user_id == "") {
                    ...
                    this.$http({
                        method: "GET",
                        url: this.$api.host + "sectest/myTest",
                        params: {}
                    }).then((res) => {
            ...
            testEndGOHome() {
                if (this.leftIcon == true) {
                    this.$router.push({path: '/testPlate', query: {MathTime: global.timestamp}});
                } else {
...
<style scoped>
    ...
    #testingEnd .testPopupLine {
        background: url("/static/img/testing/touxiang12@3x_96.png");
        background-repeat: no-repeat;
        background-size: 100% 100%;
        width: 165px;
        height: 23.8594px;
