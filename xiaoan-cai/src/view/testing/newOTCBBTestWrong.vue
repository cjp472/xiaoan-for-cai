        ...
        <div id="newOTCBBTestWrong" class="newOTCBBTestWrong">
            ...
            <div class="newOTCWrong-content">
                ...
                <p v-show="infLoading" class="infinite-loading">
                    ...
                    <span v-show="allLoaded" style="vertical-align: middle">加载中...</span>
                ...
                testing: [
                    {
                        id: "",
                        title: "本次考试错题",
                        imgUrl: "/static/img/testing/nowTestWrong@3x.png",
                        doc: "查看",
                        list: "",
                        payExamType: '',
                    }, {
                        id: "",
                        title: "历次考试错题",
                        imgUrl: "/static/img/testing/beforeTestWrong@3x.png",
                        doc: "查看",
                        testCount: "",
                        list: []
                    }
        ...
        methods: {
            ...
            loadMore() {
                ...
                setTimeout(() => {
                    ...
                    this.loading = false;
                    console.log(lastValue, this.page, this.loading);
                }, 1000);
            },
            getPayUserErrorQuestion() {
                this.$http({
                    method: "POST",
                    url: this.$api.host + "sectest/getPayUserErrorQuestion",
                    params: {
            ...
            newOTCWrongNow() {
                if (this.testing[0].list.errorCount == 0) {
                    this.$toast({message: '您本次全对了，太棒了！', position: 'middle', duration: 1000});
                } else {
                    this.$router.push({
                        path: "/newOTCBBTestWrongList",
                        query: {testId: this.$route.query.testId, MathTime: global.timestamp}
                    });
                }
            },
            newOTCWrongBefore(index) {
                if (this.testing[1].list[index].errorCount == 0) {
                    ...
                    this.$router.push({
                        path: "/newOTCBBTestWrongList",
                        query: {testId: this.testing[1].list[index].testId, MathTime: global.timestamp}
                    });
                }
            },
            lineHeight() {
